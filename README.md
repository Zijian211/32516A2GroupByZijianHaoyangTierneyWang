...
| **Haoyang Xue** | 25244500 | Security / JWT Authentication Lead | Password hashing, JWT token generation, protected routes, role-based access control, frontend token storage and Authorization header integration |
