              ...
              <div className="flex items-center gap-4">         
                ...
                {currentUser?.role === "admin" && (
                  <button
                    ...
                    className="relative bg-purple-800 text-white p-2 sm:px-5 sm:py-2.5 rounded-full font-bold hover:bg-purple-600 transition shadow-md flex items-center gap-2"
                    title="View All Users' Carts"
                  >
                    Admin Carts
                </button>
                )}
